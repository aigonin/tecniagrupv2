...
$form = array(
	'subject' => 'Envío de A-Master Form',
	...
	'email' => array(
		'from' => 'aigonin93@gmail.com',
		'to' => 'aigonin93@gmail.com'
	),
	'fields' => array(
		'Email' => array(
			'order' => 1,
			'type' => 'email',
			'label' => 'EStémos en contacto',
			'required' => true,
			'errors' => array(
				'required' => 'El campo \'EStémos en contacto\' es obligatorio.',
				'format' => 'El campo \'EStémos en contacto\' contiene un correo electrónico no válido.'
			)
		)
	)
);
